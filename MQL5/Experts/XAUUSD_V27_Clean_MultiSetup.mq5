...
#property description "V28 Contextual Router: V29 strict sweep-edge extension validation"
...
bool RouteExtensionQuality(string route,double rs,double adx,double vr,double br,int b1,int b4){
 if(route!="EDGE_SWEEP_SELL_12_15_STRICT")return true;
 return b1<0&&b4<0&&rs>=36&&rs<=46&&adx>=28&&vr>=1.20&&br>=0.60;
}
