...
#property description "V28 Contextual Router: V30 strict continuation-sell 10-11 validation"
...
bool RouteExtensionQuality(string route,double rs,double adx,double vr,double br,int b1,int b4){
 if(route!="EDGE_CONTINUATION_SELL_10_11_STRICT")return true;
 return b1<0&&b4<0&&rs>=35&&rs<=47&&adx>=28&&vr>=1.15&&br>=0.55;
}
