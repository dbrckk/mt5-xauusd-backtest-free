...
$newTune = 'Set-Content -Path (Join-Path $reportsRoot "ea_v26_settings.txt") -Value "V26 EA settings: FixedLot=0.02; MaxTradesPerDay=8; CooldownMinutes=30; hardened execution; timeframe gate enabled" -Encoding UTF8'
