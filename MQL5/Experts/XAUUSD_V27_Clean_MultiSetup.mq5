...
#property description "V28 Contextual Router: balanced intraday rollback after compressed-exit regression"
...
input double MinSignalScore=82.0;
...
input double MinBodyRatio=0.36;
input double MinVolumeRatio=1.00;
...
input double BreakEvenTriggerATR=0.75;
input double BreakEvenOffsetATR=0.03;
input bool UseTrailingStop=true;
input double TrailStartATR=1.15;
input double TrailDistanceATR=0.65;
input int MaxHoldBars=24;
input double TimeExitMinProgressATR=0.25;
